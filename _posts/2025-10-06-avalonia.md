...
> **Edit:** There is actually no need to calculate the address using very large numbers. There is the ability to input negative numbers into `scanf` with `%u`, which still works. This a undefined behavior according to this [StackOverflow article](https://stackoverflow.com/questions/38684386/scanf-u-negative-number). This makes solving the challenge easier. - Credit to **@pingotux**
